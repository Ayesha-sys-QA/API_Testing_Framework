...
public class APIConstants {
	...
	public static final String CREATE_CLASS_ENDPOINT = "/api/services/app/Class/Create";
	public static final String UPDATE_CLASS_ENDPOINT = "/api/services/app/Class/Update";
}
